...
\Large{Research Experience}
    ...
    %
    %\textbf{Research Assistant, Data Science \hfill 2020}
    %
...
\begin{enumerate}[itemsep=2pt, label={}]
    ...
    \item \textbf{Sage Fellowship}, Cornell University \hfill 2020--2021
...
\begin{enumerate}[itemsep=2pt, label={}]
    ...
    \item University of San Francisco, Data Science Conference (NSF attendence grant) \hfill 2023
    \item Cornell Economics, Labor Work in Progress Seminar \hfill 2021, 2022
\end{enumerate}
\end{document}
