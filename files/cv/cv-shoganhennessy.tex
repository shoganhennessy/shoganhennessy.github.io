...
\begin{table}[H]
    ...
    \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} r}
        ...
        Cornell University &
            \href{https://github.com/shoganhennessy}{
                \nolinkurl{github.com/shoganhennessy}} \\
        Ithaca, NY 14850 USA &
...
\Large{Education}
    ...
    &  B.A. Economics, minor Mathematics, 2018.  GPA: 3.70/4.00, major GPA 3.82/4.00 \vspace{0.1cm}  \\
    &  \textbf{London Oratory School}\\
    &  A-Levels. Economics, Mathematics, Chemistry, Biology, 2014.  GPA: 4.00/4.00 \vspace{0.2cm} \\
...
\begin{enumerate}[itemsep=2.5pt, label={}]
    ...
    %\item Add ``Text Analysis of Political Subreddits: The Trump/Clinton Dichotomy, with Shirley Jiang (2018)'' archived by Zenodo.
\end{enumerate}
...
\begin{enumerate}[noitemsep, label={}]
    \item Cornell Economics, Work in Progress Seminar 2021--
\end{enumerate}
